...
class ResponsibilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsibility" do
    assert_difference('Responsibility.count') do
      post responsibilities_url, params: { responsibility: { description: @responsibility.description, end_date: @responsibility.end_date, name: @responsibility.name, type: @responsibility.type } }
    end
  ...
  test "should update responsibility" do
    patch responsibility_url(@responsibility), params: { responsibility: { description: @responsibility.description, end_date: @responsibility.end_date, name: @responsibility.name, type: @responsibility.type } }
