...
class ConflictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conflict" do
    assert_difference('Conflict.count') do
      post conflicts_url, params: { conflict: { company_id: @conflict.company_id, control_id: @conflict.control_id, cycle_id: @conflict.cycle_id, responsibility_id: @conflict.responsibility_id } }
    end
  ...
  test "should update conflict" do
    patch conflict_url(@conflict), params: { conflict: { company_id: @conflict.company_id, control_id: @conflict.control_id, cycle_id: @conflict.cycle_id, responsibility_id: @conflict.responsibility_id } }
