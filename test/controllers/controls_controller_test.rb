...
class ControlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create control" do
    assert_difference('Control.count') do
      post controls_url, params: { control: { description: @control.description, end_date: @control.end_date, name: @control.name } }
    end
  ...
  test "should update control" do
    patch control_url(@control), params: { control: { description: @control.description, end_date: @control.end_date, name: @control.name } }
